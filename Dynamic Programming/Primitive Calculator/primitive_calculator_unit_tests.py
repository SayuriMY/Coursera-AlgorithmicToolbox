...
class PrimitiveCalculator(unittest.TestCase):
    def test_compute_operations(self):
        self.assertEqual([1], compute_operations(1))
        self.assertEqual([1, 2, 4, 5], compute_operations(5))
        self.assertEqual([1, 3, 9, 10, 11, 22, 66, 1198, 594, 1782, 3546, 16038, 16039, 32078, 96234],
                         compute_operations(96234))

    def test(self):
        for n, answer in ((2, 1), (3, 1), (5, 3), (4, 2)):
